...
function checkGameOverConditions(room) {
  ...
  if (room.winners.length >= MAX_WINNERS || allFinished) {
    ...
    io.to(room.id).emit("gameOver", {
      ...
      message:
        "ขอบคุณทุกคนที่ร่วมเล่นเกมนี้! อย่าลืมนะคะ การตรวจเต้านมด้วยตนเองเป็นประจำ และพบแพทย์เพื่อตรวจคัดกรองตั้งแต่เนิ่นๆ เป็นส่วนสำคัญในการป้องกันมะเร็งเต้านมตั้งแต่ระยะเริ่มต้น 🎗️💗"
    });
  }
}
